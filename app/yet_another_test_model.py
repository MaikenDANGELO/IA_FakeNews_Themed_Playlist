...
DATASET_URL = "hf://datasets/BeardedJohn/FakeNews/"

try:
    # Charger directement le split de TEST (test)
    df_test = pd.read_csv(DATASET_URL + splits["test"])
...
unique_filename_parquet = get_unique_filename("metrics_report_bearded.json")
